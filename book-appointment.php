...
<section class="w3l-inner-banner-main">
 ...
 Book Appointment
            ...
            <p class="tiltle-para ">A hairdresser is a person whose occupation is to cut or style hair in order to change or maintain a person's image.</p>
        </div>
</div>
</div>
               ...
               <?php } ?> </div>
                <div class="map-content-9 mt-lg-0 mt-4">
                    <form method="post">
                        ...
                        <label for="cars">Choose a Services:</label>

                        <select name="cars" id="cars">
                        <option value="volvo">Botex</option>
                        <option value="saab">Fruit Facial</option>
                        <option value="mercedes">Charcol Facial</option>
                        <option value="audi">Delux Minicure</option>
                        <option value="audi">Delux padicure</option>
                        <option value="audi">Normal Minicure</option>
                        <option value="audi">U shape hair cut</option>
                        <option value="audi">Layer haircut</option>
                        <option value="audi">Rebonding</option>
                        <option value="audi">Lorial hair color</option>
                        <option value="audi">Body Spa</option>
                        </select>
