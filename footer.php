...
?>
              ...
              <li><span class="fa fa-phone"></span><a href=" 7447245726 "> +<?php  echo $row['MobileNumber'];?></a></li>
              <li><span class="fa fa-envelope-open-o"></span><a href="shubhnhavi725@gmail.com" class="mail">
  ...
  <section class="w3l-footer-29-main w3l-copyright">
    <div class="container">
      <div class="row bottom-copies">
        <p class="col-lg-8 copy-footer-29"> Salon Management System </p>
